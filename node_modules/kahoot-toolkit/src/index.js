...
class Kahoot {
    ...
    async autoplay(quizResolvable, debug) {
        ...
        client.on("QuestionEnd", question => {
            if (debug) console.log(`${colors.bold("[").cyan}${colors.bold("Kahoot").magenta} ${colors.white("Client").white}${colors.bold("]").cyan}: Question Ended! ${question.isCorrect ? `(Correct, +${question.points} Points)` : `(Incorrect)`} Currently Rank ${question.rank}`);
        })
